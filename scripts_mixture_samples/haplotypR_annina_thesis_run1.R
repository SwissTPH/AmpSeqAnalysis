...
outputDir <- "scicore/home/mynaco16/GROUP/analysis/annina_thesis/run1/001_haplotype_calling"  
# Create output directory
if(!dir.exists(outputDir))
  dir.create(outputDir, recursive=T)

primerFile <- "/scicore/home/mynaco16/GROUP/analysis/annina_thesis/run1/001_haplotype_calling/input_files/marker_file.txt"
sampleFile <- "/scicore/home/mynaco16/GROUP/analysis/annina_thesis/run1/001_haplotype_calling/input_files/sample_file_annina_thesis_run1.txt"
fnBarcodeF <- "/scicore/home/mynaco16/GROUP/analysis/annina_thesis/run1/001_haplotype_calling/input_files/barcode_F.fasta"
fnBarcodeR <- "/scicore/home/mynaco16/GROUP/analysis/annina_thesis/run1/001_haplotype_calling/input_files/barcode_R.fasta"
reads <- list.files("/scicore/home/mynaco16/GROUP/analysis/annina_thesis/run1/001_haplotype_calling/input_files", pattern="Pool1", full.names = T)
...
procReads <- procReads[-which(procReads$SampleName == "H2O"),]  
